                ...
                <div className="display-visual">
                    ...
                    <div className="visual-content">
                        <div className="visual-left">
                            ...
                            <p className="visual-time">10:00 - 18:00</p>
                            <p className="visual-note">* 입장 마감은 폐관 30분 전까지</p>
                            <p className="visual-note">옥외 전시장(정원) 오전 7시부터 오후 9시까지</p>
                        </div>

                        <div className="visual-right">
                            <p className="visual-sub">관람료</p>
